...
cd /
mkdir -p /etc/zkey/repository/
cd /etc/zkey/repository
mkdir keys
cd keys
...
openssl req \
    ...
    -out ca/ca_cert.pem \
    -subj "/C=IN/ST=TN State/L=Acme City/O=Acme Inc./CN=example.com"
...
openssl req -new \
    ...
    -subj "/C=IN/ST=TN State/L=Acme City/O=Acme Inc./CN=server.example.com"
...
openssl req -new \
    ...
    -subj "/C=IN/ST=TN State/L=Acme City/O=Acme Inc./CN=client.example.com"
