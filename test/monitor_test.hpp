...
//     cpu_table TABLE = monitor.read_processing_time_id(process_id);
//     double cpuTime = monitor.calculate_cpu_time(TABLE);
//     EXPECT_GT(cpuTime, 0);    
// }
...
//     static int response = monitor.get_app_resource_details(entity, logs);
//     EXPECT_EQ(response, SUCCESS);
// }
