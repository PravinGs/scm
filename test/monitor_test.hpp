...
// {
//     const unsigned int process_id = 3;
//     string response = monitor.get_memory_usage(process_id);
//     DEBUG(response.empty() ? "No proces exist with this id: 1505" : response);
//     EXPECT_GT(response.length(), 0);
//     EXPECT_EQ(response , SUCCESS);
// }
...
// // {
// //     const unsigned int process_id = 12435;
// //     double response = monitor.get_memory_usage(process_id) ;
// //     EXPECT_EQ(response ,FAILED);
// // }
 
// // TEST_F(MONITOR_TEST , GetDiskUsageValidInput)
// // {
// //     const unsigned int process_id =1634 ;
...
// // {
// //     const unsigned int process_id = 130 ;
// //     string response = monitor.create_process_data(process_id) ;
// //     EXPECT_EQ(response ,SUCCESS);
// // }
 
// // TEST_F(MONITOR_TEST , CreateProcessDataWithInValidInput)
// // {
// //     const unsigned int process_id = 4365;
// //     string response = monitor.create_process_data(process_id) ;
// //     EXPECT_EQ(response ,FAILED);
// // }
