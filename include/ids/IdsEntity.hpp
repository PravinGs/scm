...
typedef struct ProcessedAConfigServiceRule PRule;
typedef struct IdentifiedAConfigServiceRule IdRule;
...
struct ProcessedAConfigServiceRule
{
    ...
    /**
     * @brief Default constructor for the PRule structure.
     *
     * Initializes the PRule structure with default values for its attributes.
     */
    ProcessedAConfigServiceRule() : id(0), if_sid(0), if_mid(0), same_source_ip(0),
        same_id(0), time(0), frequency(0), d_frequency(0) {}
};
 
struct IdentifiedAConfigServiceRule
{
    string group;
    int id;
 
    IdentifiedAConfigServiceRule(const string& group, const int id) : group(group), id(id) {}
    IdentifiedAConfigServiceRule() {}
};
...
struct LogEvent
{
    ...
    /**
     * @brief Default constructor for the LogEvent structure.
     *
     * Initializes an instance of the LogEvent structure with default values
     * for its attributes.
     */
    LogEvent() : size(0L), is_matched(0), rule_id(0) {}
};
 
struct AConfigService
{
    int id;
    int level;
    int if_sid;
    ...
    AConfigService() : id(0), level(0), if_sid(0), if_matched_id(0), same_source_ip(0), frequency(0),
